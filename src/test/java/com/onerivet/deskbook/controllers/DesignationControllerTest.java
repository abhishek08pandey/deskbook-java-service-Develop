...
class DesignationControllerTest {
	...
	@Mock private DesignationServiceImpl designationServiceImpl;
	
	@Mock private DesignationService designationService;
	
	@InjectMocks private DesignationController designationController;
	
	@Mock private GenericResponse<List<DesignationDto>> listOfDesignation;
