...
public class UpdateSeatUtils {
	...
	public void checkExceptions(Employee employee, UpdateProfileDto newEmployeeDto) {
		...
		if((newEmployeeDto.getModeOfWork() == 1 || newEmployeeDto.getModeOfWork() == 3) && newEmployeeDto.getCity() == null) {
			throw new IllegalArgumentException("Please Enter City");
		}
		if((newEmployeeDto.getModeOfWork() == 1 || newEmployeeDto.getModeOfWork() == 3) && newEmployeeDto.getFloor() == null) {
			throw new IllegalArgumentException("Please Enter Floor");
		}
		if((newEmployeeDto.getModeOfWork() == 1 || newEmployeeDto.getModeOfWork() == 3) && newEmployeeDto.getColumn() == null) {
			throw new IllegalArgumentException("Please Enter Column");
		}
		if((newEmployeeDto.getModeOfWork() == 1 || newEmployeeDto.getModeOfWork() == 3) && newEmployeeDto.getSeat() == null) {
			throw new IllegalArgumentException("Please Enter Seat");
		}
		...
		if(newEmployeeDto.getModeOfWork() ==  2 && (newEmployeeDto.getColumn() != 1 && newEmployeeDto.getColumn() != 42)) {
			throw new IllegalArgumentException("Enter Valid Column");
		}
		
		if(newEmployeeDto.getModeOfWork() ==  2 && (newEmployeeDto.getSeat() != 1 && newEmployeeDto.getSeat() != 402)) {
	...
	public Employee getUpdatedEmployee(Employee employee, UpdateProfileDto newEmployeeDto) throws Exception {
		...
		if (newEmployeeDto.getProfilePictureFileString() != null) {
			...
			employee.setProfilePictureFilePath(
					path + newEmployeeDto.getFirstName() + "_" + employee.getId() + fileExtension);
